...
namespace Common.Library.Constant
{
    public class MessageConstant
    {
        ...
        public static string DON_VI_SU_DUNG = "Công ty Cổ Phần Đầu Tư và Phát Triển Đa Quốc Gia IDI";
        public static string DON_VI_SU_DUNG_MAIN = "Công ty Cổ Phần Đầu Tư và Phát Triển Đa Quốc Gia IDI";
